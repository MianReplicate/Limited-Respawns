package mc.mian.limitedrespawns.registry.forge;

import mc.mian.limitedrespawns.forge.LimitedLivesForge;
...
public class DeferredRegistryImpl {
    ...
    public static class Impl<T> extends DeferredRegistry<T> {
        ...
        public void register() {
            this.register.register(LimitedLivesForge.modEventBus);
        }
