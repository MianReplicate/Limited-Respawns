package mc.mian.limitedrespawns.registry.neoforge;

import mc.mian.limitedrespawns.neoforge.LimitedLivesNeoForge;
import mc.mian.limitedrespawns.registry.DeferredRegistry;
import mc.mian.limitedrespawns.registry.RegistrySupplier;
import mc.mian.limitedrespawns.registry.RegistrySupplierHolder;
...
public class DeferredRegistryImpl {
    ...
    public static class Impl<T> extends DeferredRegistry<T> {
        ...
        public void register() {
            this.register.register(LimitedLivesNeoForge.modEventBus);
        }
