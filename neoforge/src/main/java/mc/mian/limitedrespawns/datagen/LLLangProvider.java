...
public class LLLangProvider extends LanguageProvider {
    public static final String MOD_ID = LRConstants.MOD_ID;
    
    public LLLangProvider(PackOutput output) {
    ...
    public void addItemGroup(String title, String translation){
        add("itemGroup."+ LRConstants.MOD_ID+"."+title, translation);
    }

    public void addSound(String title, String translation){
        add(LRConstants.MOD_ID+".sounds."+title, translation);
    }

    public void addKeybind(String title, String translation){
        add(LRConstants.MOD_ID+".keybinds."+title, translation);
    }
    ...
    protected void addTranslations() {
        ...
        addJukeboxSong(LRConstants.TEMPLATE_JUKEBOX_SONG, "Tanger - Scratch!");
