...
import mc.mian.limitedrespawns.datagen.LLDataGenerators;
...
public class LimitedLivesNeoForge {
    ...
    public LimitedLivesNeoForge(IEventBus modEventBusParam) {
...
//        ModLoadingContext.get().getActiveContainer().registerExtensionPoint(IConfigScreenFactory.class, ConfigurationScreen::new);
        ...
        modEventBus.register(LLDataGenerators.class);
    }
}